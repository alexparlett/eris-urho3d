...
#include "Editor/EditorHierarchyWindow.as"
#include "Editor/EditorView.as"
#include "Editor/EditorScene.as"
#include "Editor/EditorActions.as"
#include "Editor/EditorUIElement.as"
#include "Editor/EditorGizmo.as"
#include "Editor/EditorMaterial.as"
...
void Start(bool production_, const String& version_)
{
    ...
    configFileName = fileSystem.userDocumentsDir + "My Games/Solarian Wars/editor-settings.xml";

    if (engine.headless)
    {
        ErrorDialog("Editor", "Headless mode is not supported. The program will now exit.");
        engine.Exit();
        return;
    }
