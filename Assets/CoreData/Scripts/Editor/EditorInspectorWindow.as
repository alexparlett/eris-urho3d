...
void CreateAttributeInspectorWindow()
{
    ...
    attributeInspectorWindow.SetSize(300, ui.root.height - 90);
...
void HandleInspectorWindowLayoutUpdated()
{
	attributeInspectorWindow.SetFixedHeight(ui.root.height - 90);
	attributeInspectorWindow.SetPosition(ui.root.width - attributeInspectorWindow.width, ui.root.height - attributeInspectorWindow.height - 30);
...
void UpdateAttributeInspector(bool fullUpdate = true)
{
    ...
    if (fullUpdate)
        HandleInspectorWindowLayoutUpdated();
}
